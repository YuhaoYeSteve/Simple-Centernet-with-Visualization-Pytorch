...
import sys
sys.path.append(r'/datav/yyh/centernet/laodu_origin/networks/DCNv2')
...
class DCN(DCNv2):
    ...
    # DCN其实就是多加了一个个卷积而已，大小固定是27*h*w(h,w是输入feature map的大小) 9个通道是x的偏移量，9个通道是y的偏移量, 9个通道是mask
    # DCN速度会变慢，因为对于feature map上每个点都会有偏移，而偏移以后大概率不会落到正好有像素的位置
